...
import firstBikeImage from "../Images/Bikes/first_bike.jpg"
import secondBikeImage from "../Images/Bikes/second_bike.jpg"
import thirdBikeImage from "../Images/Bikes/third_bike.jpg"

const bikeProducts : IBike[] = [
    {
        id: "b001",
        ...
        image: firstBikeImage,
        description: "Perfect for mountain trails and rough terrain, the Mountain Explorer X500 offers superior control and comfort.",
    ...
    },
    {
        ...
        image: secondBikeImage,
        description: "The perfect companion for city commuting, featuring comfortable riding position and practical accessories.",
    ...
    },
    {
        ...
        image: thirdBikeImage,
        description: "Professional-grade road bike for serious cyclists. Lightweight carbon frame and premium components.",
